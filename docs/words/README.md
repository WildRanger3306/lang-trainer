...
1. Скан — `raw/<учебник>/NNNN.jpg` (например `Starlight_5`, `starlight_6`, `Starlight_7`, `loiseau_blue_5`, `loiseau_blue_6`, `fr_trainer`).
...
**IPA (EN / Starlight 5–7):** словарь [docs/words/ipa/en_UK.txt](ipa/en_UK.txt) (British), скрипт `fill_en_transcriptions.py` (`--skip-pos phrase`). Упрощение: `ɫ→l`, `ɹ→r`, `ɡ→g`.
